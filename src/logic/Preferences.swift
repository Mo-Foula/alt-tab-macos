...
class Preferences {
    ...
    static var defaultValues: [String: String] = [
        ...
        "hideAppsWithNoOpenWindows": ShowHowPreference.showAtTheEnd.indexAsString,
        "hideAppsWithNoOpenWindows2": ShowHowPreference.showAtTheEnd.indexAsString,
        "hideAppsWithNoOpenWindows3": ShowHowPreference.showAtTheEnd.indexAsString,
        "hideAppsWithNoOpenWindows4": ShowHowPreference.showAtTheEnd.indexAsString,
        "hideAppsWithNoOpenWindows5": ShowHowPreference.showAtTheEnd.indexAsString,
